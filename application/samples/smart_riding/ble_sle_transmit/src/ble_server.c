...
#define BLE_UART_SERVICE_NUM 5

#define MAXTXOCTETS 251
#define MAXTXTIME 2120

static uint16_t g_ble_uart_conn_id;
static uint8_t g_ble_uart_name_value[] = { 's','l','e','_','b', 'i','k', 'e','_','t','e','s','t' };
static uint8_t g_uart_server_app_uuid[] = { 0x00, 0x00 };
static uint8_t g_uart_server_uart_uuid[] = { 0xAB, 0xCD };
static uint8_t g_uart_server_battery_uuid[] = { 0x18, 0x0f };
static uint8_t g_uart_server_auto_uuid[] = { 0x18, 0x15 };
static uint8_t g_ble_uart_server_addr[] = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB };
...
static errcode_t ble_uart_server_register_callbacks(void)
{
    ...
    gap_cb.read_rssi_cb = ble_server_print_rssi_cbk;
